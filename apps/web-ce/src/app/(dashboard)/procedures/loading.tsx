            ...
            <div className="flex-1 min-h-0 px-6 pb-4 flex gap-4 overflow-x-auto no-scrollbar">
                {Array.from({ length: 5 }).map((_, i) => (
                    <div key={i} className="min-w-[280px] w-[280px] flex flex-col gap-3">
                        ...
                        {/* Cards Skeletons */}
                        <Skeleton className="h-32 rounded-2xl bg-card border border-border" />
                        <Skeleton className="h-28 rounded-2xl bg-card border border-border" />
                        <Skeleton className="h-36 rounded-2xl bg-card border border-border" />
                    </div>
                ))}
            </div>
        </div>
